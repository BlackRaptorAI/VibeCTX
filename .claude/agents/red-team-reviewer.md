...
## Feedback loop
When a real incident or human-pentest finding reveals something you missed, that goes in `AGENT-RETROS.md` and amends this agent — the adversary teaches the red team.
